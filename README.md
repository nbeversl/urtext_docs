...
A Markdown export of this document is included in the documentation folder and readable
...
Like any node, the Metadata List can be traversed in Sublime using Traverse Mode ("Traverse Mode"). You can also link to it from anywhere by its node ID, like this:"Metadata List". 
